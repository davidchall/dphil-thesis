...
Higgs boson as heavy as an atom of caesium-133, which is used in atomic clocks.
...
evidence that the discovered particle is spin-0 (the only known scalar particle). 
