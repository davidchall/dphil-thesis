...
accordance with Noether's theorem \cite{Noether:1918}. \ac{QCD} of \SUgroup{3} describes 
the strong interaction, is mediated by eight gluons, and couples to colour charge. \ac{QED}
of \Ugroup{1} describes the electromagnetic interaction, is mediated by the 
