...
\unit{$\Lambda_{\text{P}}~\about~10^{18}$}{\GeV} (where we expect new physics describing 
gravity) places an upper bound on \mH of \unit{175}{\GeV} \cite{Ellis:2009}.
...
$\Lambda_{\text{P}}$ places a lower bound on \mH of \unit{129}{\GeV} \cite{Ellis:2009}. 
...
\about$\Lambda_{\text{P}}$, the \ac{EW} vacuum has a lifetime longer than the age of the 
Universe if \mH $>$ \unit{122}{\GeV} (pale blue band in 
