...
ggF). The exact nature of these terms depends upon the process and also the jet 
algorithm and parameters (\eg \antikt with $R=0.4$). They are analogous to the 
logarithms introduced by soft gluon emission, described in \Section~\ref{sec:qcd:resum}. 
...
Perturbative corrections to $\sigma_{\total}$ are large in ggF and, when 
