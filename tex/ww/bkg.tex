...
factors are measured to be \stat{1.21}{0.03} in the 0-jet bin and \stat{1.05}{0.05} in the 
...
Extrapolation uncertainties for the VR are also shown. 
...
Two kinds of diagrams can be identified for the \WW~+~2~jets process: EW production (zero QCD 
