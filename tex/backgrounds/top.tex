...
modelled by \meps{\powhegbox}{\pythia{6}}, while $t$-channel single top 
(\HepProcess{\Ptop\Pbottom\Pquark}) is modelled by \meps{\acermc}{\pythia{6}}. However, the 
...
The total uncertainties in the expected 0-jet top background is \about8\%, dominated by 
...
The total uncertainty in the expected 1-jet top background is \about7\%, dominated by 
