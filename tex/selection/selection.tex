...
Lepton trigger efficiencies are measured via tag-and-probe (see 
...
Low mass hadronic resonances with dileptonic decays (\eg \PJpsi and \PUpsilon) are removed 
...
\begin{figure}
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutMll_Mll_mh125_log}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/eemm_CutMll_Mll_mh125_log}
...
\begin{figure}
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutZVeto_MET_TrackHWW_Clj_mh125_log}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/eemm_CutZVeto_METRel_mh125_log}
...
\begin{figure}[t]
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutMETRel_m_jet_n_upTo7_mh125_lin}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/eemm_CutMETRel_m_jet_n_upTo7_mh125_lin}
...
\begin{figure}[t]
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutDPhillMET_0jet_Ptll_mh125_log}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/eemm_CutDPhillMET_0jet_Ptll_mh125_log}
...
\begin{figure}
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/eemm_CutTopoMll_0jet_METRel_TrackHWW_mh125_log}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/eemm_CutTopoDPhill_0jet_f_recoil_mh125_log}
...
\begin{figure}
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutFRecoil_0jet_MT_TrackHWW_Clj_mh125_lin}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/eemm_CutFRecoil_0jet_MT_TrackHWW_Clj_mh125_lin}
...
\begin{figure}[t]
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutbVeto_1jet_MaxMTW_TrackHWW_Clj_mh125_lin}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutMaxMTlep_1jet_Mtt_TrackHWW_Clj_mh125_lin}
...
\begin{figure}[b]
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/eemm_CutTopoMll_1jet_METRel_TrackHWW_mh125_log}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/eemm_CutTopoDPhill_1jet_f_recoil_ext_mh125_log}
	\caption{The \trackmetrel (left) and \frecoil (right) distributions in the \eech/\mmch 
	channels. The subsequent selection removes events to the left of the dashed line in the 
	\trackmetrel plot, and removes events to the right of the dashed line in the \frecoil 
	plot.}
...
\begin{figure}[t]
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutFRecoil_1jet_MT_TrackHWW_Clj_mh125_lin}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/eemm_CutFRecoil_1jet_MT_TrackHWW_Clj_mh125_lin}
...
\begin{figure}[t]
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutFailVBF_2jetincl_nJets_Pt20_MV1_85_mh125_lin}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutFailVBFbVeto_2jetincl_Mtt_TrackHWW_Clj_mh125_lin}
...
\begin{figure}[t]
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutFailVBFTopoDPhillggFlike_2jetincl_MT_TrackHWW_Clj_mh125_lin}
...
\begin{sidewaystable}[p]
	...
	\begin{tabularx}{1.05\textwidth}{l *{6}{Y}}
		...
		&&& \multicolumn{2}{c}{$\dphill < 1.8$} \\ [1ex]
		\cmidrule(lr){2-7}
		...
		& \multicolumn{2}{c}{--} & \multicolumn{2}{c}{--} & \multicolumn{2}{c}{Fail CJV, OLV \textbf{or} \{BDT \textbf{and}} \\
		& \multicolumn{2}{c}{--} & \multicolumn{2}{c}{--} & \multicolumn{2}{c}{($\mjj > 600$ \textbf{or} $\dyjj > 3.6$)\}} \\
		Reject \VH
		& \multicolumn{2}{c}{--} & \multicolumn{2}{c}{--} & \multicolumn{2}{c}{Fail $\dyjj < 1.2$ \textbf{or} $\mods{\mjj - 85} < 15$} \\
		\bottomrule
	\end{tabularx}
...
\begin{figure}[p]
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutFRecoil_0jet_lepPtSublead_zoom_mh125_lin}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutFRecoil_0jet_Mll_zoom_mh125_lin}
	\\
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutFRecoil_1jet_lepPtSublead_zoom_mh125_lin}
	\hfill
	\includegraphics[width=0.495\textwidth]{tex/selection/\blindfolder/emme_CutFRecoil_1jet_Mll_zoom_mh125_lin}
